      ...
      {  
         ...
         try {
             ...
             Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/registration?useSSL=false", "root","root");
              ...
              PreparedStatement ps = con.prepareStatement("select education_detail.user,education_detail.cetmarks from education_detail where education_detail.cetmarks>=60 AND education_detail.cetmarks<70  order by education_detail.cetmarks DESC;");
